                ...
                <div class="card car-transparent">
                    <div class="card-body p-0">
                        <div class="profile-image position-relative">
                            <img src="{{ asset('images/download.jpg') }}" class="img-fluid rounded w-100" alt="profile-image">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="profile-img position-relative">
                                <img src="{{ asset('images/default.png') }}" class="img-fluid rounded avatar-110"
                                    alt="profile-image">
                            </div>
                            <div class="ml-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="profile-content tab-content">
                            ...
                            <div id="profile1" class="tab-pane fade active show">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Turpis viverra viverra
                                    mollis
                                    sed vitae fames
                                ...
                                <div class="row">
                                        ...
                                        <ul class="list-inline p-0 m-0">
                                            <li class="mb-4">
                                                <div class="d-flex align-items-center pt-2">
                                                    <img src="../assets/images/profile/service/01.png" class="img-fluid"
                                                        alt="image">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-center pt-2">
                                                    <img src="../assets/images/profile/service/03.png" class="img-fluid"
                                                        alt="image">
                                                    <div class="ml-3 w-100">
                                                        <div class="media align-items-center justify-content-between">
                                                            <p class="mb-0">Adobe Photoshop</p>
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="list-inline p-0 m-0">
                                            <li class="mb-4">
                                                <div class="d-flex align-items-center pt-2">
                                                    <img src="../assets/images/profile/service/04.png" class="img-fluid"
                                                        alt="image">
                                                    <div class="ml-3 w-100">
                                                        <div class="media align-items-center justify-content-between">
                                                            <p class="mb-0">Adobe Photoshop</p>
                                            ...
                                            <li class="mb-4">
                                                <div class="d-flex align-items-center pt-2">
                                                    <img src="../assets/images/profile/service/05.png" class="img-fluid"
                                                        alt="image">
                                                    <div class="ml-3 w-100">
                                                        <div class="media align-items-center justify-content-between">
                                                            <p class="mb-0">Figma</p>
                                            ...
                                            <li>
                                                <div class="d-flex align-items-center pt-2">
                                                    <img src="../assets/images/profile/service/06.png" class="img-fluid"
                                                        alt="image">
                                                    <div class="ml-3 w-100">
                                                        <div class="media align-items-center justify-content-between">
                                                            <p class="mb-0">Adobe Photoshop</p>
                            ...
                            <div id="profile5" class="tab-pane fade">
                                ...
                                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Iaculis
                                    mattis
                                    nam ipsum pharetra porttitor eu.
